...
public class RedContourVisionProcessor implements VisionProcessor {
    ...
    public Scalar lowerRed = new Scalar(157, 0, 0);
    public Scalar upperRed = new Scalar(181, 255, 255);
